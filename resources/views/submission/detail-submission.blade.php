...
<div class="card shadow mt-5 border-left-primary">
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <p class="col-md-6"><strong>TANGGAL TICKET :</strong>{{$submission->created_at}}</p>
            <p class="col-md-6">

                <strong>TANGGAL PROSES :</strong>
                @if($progress->schedule == null)
                belum di ajukan schedule
...
@if(Auth::user()->level != 'teknisi' || Auth::user()->role == 'kap_teknisi'|| Auth::user()->role == 'admin')
